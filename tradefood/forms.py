...
class OfferFormCustom(forms.Form):
  ...
  receive_sms_notifications = forms.BooleanField(label="Receive SMS notifications for bids")
...
class BidFormCustom(forms.Form):
  ...
  receive_sms_notifications = forms.BooleanField(label="Receive SMS notification when bid is accepted")
